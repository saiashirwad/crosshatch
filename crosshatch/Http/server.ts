...
export const layerMiddleware = HttpRouter.middleware<{ readonly provides: ResolvedPayload }>()(
  (httpEffect) =>
    Effect.gen(function* () {
      ...
      return yield* Effect.provideService(httpEffect, ResolvedPayload, payload)
    }),
  { global: true },
)
